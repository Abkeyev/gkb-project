            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 offset-md-3">
                        <form>
                            {step === 0 ? (<div className="special-card">
                                ...
                                <div className="register-input">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control check-icon" type="name" placeholder="Введите пароль" />
                                    </div>
                                    <div className="form-group">
                             ...
                             : step === 1 ? (
                                ...
                                : (<div className="special-card">
                                    ...
                                    <h3 className="title-subhead mb-16">Данные организации</h3>
                                    <p className="text-desc">Данные включают в себя информацию о компании, которая собирается
                                        подключать контр агентов для использования в системе ГКБ</p>
