...
const SignersInnerSecondStep = ({ request, main }: SignersInnerProps) => {
  return (
        ...
        {request._getDogovors &&
          (request._getDogovors.length === 0 ? (
            ...
            <table className='table req-table'>
              ...
              <tbody>
                {request._getDogovors &&
                  (request._getDogovors as Documents[]).map((d: Documents) => (
                    <tr
                      onClick={() => {
                        main.setModal(true);
                        main.setModalType(2);
...
export default observer(SignersInnerSecondStep);
